...
// for the commenting purposes Chatgpt is acknowledged as Dave
import (
	"log"
	"os"
	"strconv"
...
func main() {
	...
	// 2) Collective RelinearizationKey generation ( I am guessing this is for Bootstraping)
	RelinearizationKey := rkgphase(params, crs, P)

	// 3) Collective GaloisKeys generation ( Dave says this is for Rotation Operations)
	galKeys := gkgphase(params, crs, P)

	// Instantiates EvaluationKeySet (no idea what this is :')  )
